...
// Fri Jan 13 14:23:21 2017 by ROOT version 5.34/34
...
#ifndef Jan2017sWeight_Plotting5_h
#define Jan2017sWeight_Plotting5_h
...
class Jan2017sWeight_Plotting5 : public TSelector, public THSOutput {
public :
   ...
   Jan2017sWeight_Plotting5(TTree * /*tree*/ =0) : fChain(0),fWeights(0) { }
   virtual ~Jan2017sWeight_Plotting5() { }
...
//Add THSHisto functions
   ...
   ClassDef(Jan2017sWeight_Plotting5,0);
};

#endif

#ifdef Jan2017sWeight_Plotting5_cxx
void Jan2017sWeight_Plotting5::Init(TTree *tree)
{
...
Bool_t Jan2017sWeight_Plotting5::Notify()
{
...
#endif // #ifdef Jan2017sWeight_Plotting5_cxx
