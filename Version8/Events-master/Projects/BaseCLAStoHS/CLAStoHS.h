...
class CLAStoHS : public TSelector, public  THSOutput {
  ...
  TLorentzVector* fMissingGammaP; // The missing 4-vector before removing the detected particles.
...
public :
 ...
 CLAStoHS(TTree * /*tree*/ =0) : THSOutput(), fHSgamma(0), fMissing(0), fMissingGammaP(0), fChain(0) { }
