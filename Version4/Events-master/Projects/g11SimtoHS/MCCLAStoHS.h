...
class MCCLAStoHS : public TSelector, public THSOutput {
  ...
  TLorentzVector* fProton; // The proton 4-vector
  TLorentzVector* fPiP; // The Pi+ 4-vector
  TLorentzVector* fPiM; // The Pi- 4-vector
   //public:
  ...
  Int_t ParticleID(Int_t);                      // Use a particular Track ID method, return the PDG ID
  Int_t h10ID(Int_t);                           // TrackID : from h10 ntuple
 ...
 MCCLAStoHS(TTree * /*tree*/ =0) :THSOutput(), fHSgamma(0), fMissing(0), fMCParticle(0),fp4rec(0), fp4true(0),fATE(0),fATPx(0),fATPy(0),fATPz(0),fATPdg(0),fATtrE(0),fATtrPx(0),fATtrPy(0),fATtrPz(0),fATtrPdg(0),fChain(0), fProton(0), fPiP(0), fPiM(0) { }
   virtual ~MCCLAStoHS();
