{
 ...
 OutName="/phys/linux/s0677668/Haspect/OmegaPiPPiMPDataPortion/2016/May/GeneratedData/1milPhaseSpace/";   // The name of the output directory or file
 SelName="Corrected2";    // The name of the selector to be produced
