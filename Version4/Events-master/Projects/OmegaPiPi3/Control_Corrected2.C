{
  //Set up the input chain to be analysed
   ...
   // tree->Add("/Disk/ds-sopa-group/np/thehubdata/thehub6/shughes/Haspect/OmegaPiPi/GeneratedEvents/PhaseSpaceEdGen1mil/Processed1/g11_simon_centos61001.bos.evt.recsis.root");
   ...
   // tree->Add("/Disk/ds-sopa-group/np/thehubdata/thehub6/shughes/Haspect/OmegaPiPi/GeneratedEvents/A2EdGen1mil/Processed1/A2Decays*.root");
   tree->Add("/Disk/ds-sopa-group/np/thehubdata/thehub6/shughes/Haspect/OmegaPiPi/GeneratedEvents/ps10mil/MCAnalysis/PSTestFullPhiMissOmega1.root");
   ...
   gSystem->Setenv("HSOUT",
		   "/phys/linux/s0677668/Haspect/OmegaPiPPiMPDataPortion/2016/May/GeneratedData/10milPSDecays/");
