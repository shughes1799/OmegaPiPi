
{
 ...
 TFile *f = new TFile("Feb2017NormScaleFacHalfSB10milPS.root","RECREATE");
 ...
 TFile *myFile = TFile::Open("Feb2017BinnedEgamma1p5to2p7.root");
...
//  TH1D *slice_histo1;
//  TF1 *s1g2    = new TF1("s1g2","gaus",0.765,0.80);
//  TF1 *s1g1    = new TF1("s1g1","pol3",0.82,0.84);
//  TF1 *total1 = new TF1("total1","pol3(0)",0.722,0.842);
//  total1->SetLineColor(3);
 
//  slice_histo1 = MOmvsMXSide_All->ProjectionX("Slice1 Fit",1,20);
//  //slice_histo1 = MmissSide_All;

//  slice_histo1->Fit(s1g1,"R");
//  slice_histo1->Fit(s1g2,"R+");
//  s1g1->GetParameters(&par1[0]);
//  s1g2->GetParameters(&par1[4]);
//  total1->SetParameters(par1);
//  slice_histo1->Fit(total1,"R+");
//  slice_histo1->Draw();
//  slice_histo1->SetDirectory(f);

//  Double_t IntegralLeft=total1->Integral(0.722, 0.752);
//  Double_t IntegralMiddle=total1->Integral(0.752, 0.812);
//  Double_t IntegralRight=total1->Integral(0.812, 0.842);
//  Double_t IntegralTotal=total1->Integral(0.722, 0.842);
...
//  TF1 *s2g1    = new TF1("s2g1","pol3",0.82,0.84);
//  TF1 *total2 = new TF1("total2","pol3(0)",0.722,0.842);
//  total2->SetLineColor(3);
 
//  slice_histo2 = MOmvsMXSide_All->ProjectionX("Slice2 Fit",21,40);
//  //slice_histo2 = MmissSide_All;

//  slice_histo2->Fit(s2g1,"R");
//  slice_histo2->Fit(s2g2,"R+");
//  s2g1->GetParameters(&par2[0]);
//  s2g2->GetParameters(&par2[4]);
//  total2->SetParameters(par2);
//  slice_histo2->Fit(total2,"R+");
//  slice_histo2->Draw();
//  slice_histo2->SetDirectory(f);

//  Double_t IntegralLeft=total2->Integral(0.722, 0.752);
//  Double_t IntegralMiddle=total2->Integral(0.752, 0.812);
//  Double_t IntegralRight=total2->Integral(0.812, 0.842);
//  Double_t IntegralTotal=total2->Integral(0.722, 0.842);
...
//  TF1 *s3g1    = new TF1("s3g1","pol3",0.82,0.84);
//  TF1 *total3 = new TF1("total3","pol3(0)",0.722,0.842);
//  total3->SetLineColor(3);
 
//  slice_histo3 = MOmvsMXSide_All->ProjectionX("Slice3 Fit",41,60);
//  //slice_histo2 = MmissSide_All;

//  slice_histo3->Fit(s3g1,"R");
//  slice_histo3->Fit(s3g2,"R+");
//  s3g1->GetParameters(&par3[0]);
//  s3g2->GetParameters(&par3[4]);
//  total3->SetParameters(par3);
//  slice_histo3->Fit(total3,"R+");
//  slice_histo3->Draw();
//  slice_histo3->SetDirectory(f);

//  Double_t IntegralLeft=total3->Integral(0.722, 0.752);
//  Double_t IntegralMiddle=total3->Integral(0.752, 0.812);
//  Double_t IntegralRight=total3->Integral(0.812, 0.842);
//  Double_t IntegralTotal=total3->Integral(0.722, 0.842);
...
//  TF1 *s4g1    = new TF1("s4g1","pol4",0.82,0.84);
//  TF1 *total4 = new TF1("total4","pol4(0)",0.722,0.842);
//  total4->SetLineColor(3);
 
//  slice_histo4 = MOmvsMXSide_All->ProjectionX("Slice4 Fit",61,80);
//  //slice_histo2 = MmissSide_All;

//  slice_histo4->Fit(s4g1,"R");
//  slice_histo4->Fit(s4g2,"R+");
//  s4g1->GetParameters(&par4[0]);
//  s4g2->GetParameters(&par4[4]);
//  total4->SetParameters(par4);
//  slice_histo4->Fit(total4,"R+");
//  slice_histo4->Draw();
//  slice_histo4->SetDirectory(f);

//  Double_t IntegralLeft=total4->Integral(0.722, 0.752);
//  Double_t IntegralMiddle=total4->Integral(0.752, 0.812);
//  Double_t IntegralRight=total4->Integral(0.812, 0.842);
//  Double_t IntegralTotal=total4->Integral(0.722, 0.842);
...
//  TF1 *s5g1    = new TF1("s5g1","pol5",0.82,0.84);
//  TF1 *total5 = new TF1("total5","pol5(0)",0.722,0.842);
//  total5->SetLineColor(3);
 
//  slice_histo5 = MOmvsMXSide_All->ProjectionX("Slice5 Fit",51,100);
//  //slice_histo2 = MmissSide_All;

//  slice_histo5->Fit(s5g1,"R");
//  slice_histo5->Fit(s5g2,"R+");
//  s5g1->GetParameters(&par5[0]);
//  s5g2->GetParameters(&par5[4]);
//  total5->SetParameters(par5);
//  slice_histo5->Fit(total5,"R+");
//  slice_histo5->Draw();
//  slice_histo5->SetDirectory(f);

//  Double_t IntegralLeft=total5->Integral(0.722, 0.752);
//  Double_t IntegralMiddle=total5->Integral(0.752, 0.812);
//  Double_t IntegralRight=total5->Integral(0.812, 0.842);
//  Double_t IntegralTotal=total5->Integral(0.722, 0.842);

//  cout << "Integral of Left Events 5 " << IntegralLeft << endl;
//  cout << "Integral of Middle Events 5 " << IntegralMiddle << endl;
//  cout << "Integral of Right Events 5 " << IntegralRight << endl;
//  cout << "Integral of Total Events 5 " << IntegralTotal << endl;

// //Slice rho decay looking for 1675

//  // Double_t parRho[7];
//  // TH1F *slice_histoRho;
//  // TF1 *sRhog2    = new TF1("sRhog2","gaus",0.765,0.8);
//  // //TF1 *sRhog1    = new TF1("sRhog1","pol1",0.82,0.87);
//  // //TF1 *sRhog1    = new TF1("sRhog1","pol2",0.82,0.87);
//  // TF1 *sRhog1    = new TF1("sRhog1","pol3",0.82,0.84);

//  // TF1 *totalRho = new TF1("totalRho","pol3(0)+gaus(4)",0.722,0.842);
//  // totalRho->SetLineColor(3);
 
//  // //slice_histoRho = MOmvsMXAll_All->ProjectionX("SliceRho Fit",1,100);
//  // slice_histoRho = MmissSide_All;
 
//  // // slice_histoRho->Fit(sRhog1,"R");
//  // // slice_histoRho->Fit(sRhog2,"R+");
 
//  // MmissSide_All->Fit(sRhog1,"R");
//  // MmissSide_All->Fit(sRhog2,"R+");
 
//  // sRhog1->GetParameters(&parRho[0]);
//  // sRhog2->GetParameters(&parRho[4]);
//  // totalRho->SetParameters(parRho);
//  // slice_histoRho->Fit(totalRho,"R+");
//  // slice_histoRho->Draw();
//  // slice_histoRho->SetDirectory(f);

//  // Double_t IntegralLeft=totalRho->Integral(0.722, 0.752);
//  // Double_t IntegralMiddle=totalRho->Integral(0.752, 0.812);
//  // Double_t IntegralRight=totalRho->Integral(0.812, 0.842);
//  // Double_t IntegralTotal=totalRho->Integral(0.722, 0.842);

//  // cout << "Integral of Left Events Rho" << IntegralLeft << endl;
//  // cout << "Integral of Middle Events Rho" << IntegralMiddle << endl;
//  // cout << "Integral of Right Events Rho" << IntegralRight << endl;
//  // cout << "Integral of Total Events Rho" << IntegralTotal << endl;

//  //Slice 6 - Fitting Guas + polynomial over the full range of mass omega.
//  Double_t par6[7];
//  TH1F *slice_histo6;
//  TF1 *s6g2    = new TF1("s6g2","gaus",0.765,0.8);
//  //TF1 *s6g1    = new TF1("s6g1","pol1",0.82,0.87);
//  //TF1 *s6g1    = new TF1("s6g1","pol2",0.82,0.87);
//  TF1 *s6g1    = new TF1("s6g1","pol3",0.82,0.87);

//  TF1 *total6 = new TF1("total6","pol3(0)+gaus(4)",0.692,0.872);
//  total6->SetLineColor(3);
 
//  //slice_histo6 = MOmvsMXAll_All->ProjectionX("Slice6 Fit",1,100);
//  slice_histo6 = MmissAll_All;
 
//  // slice_histo6->Fit(s6g1,"R");
//  // slice_histo6->Fit(s6g2,"R+");

//  MmissAll_All->Fit(s6g1,"R");
//  MmissAll_All->Fit(s6g2,"R+");
 
//  s6g1->GetParameters(&par6[0]);
//  s6g2->GetParameters(&par6[4]);
//  total6->SetParameters(par6);
//  slice_histo6->Fit(total6,"R+");
//  slice_histo6->Draw();
//  slice_histo6->SetDirectory(f);

//  Double_t IntegralLeft=total6->Integral(0.692, 0.752);
//  Double_t IntegralMiddle=total6->Integral(0.752, 0.812);
//  Double_t IntegralRight=total6->Integral(0.812, 0.872);
//  Double_t IntegralTotal=total6->Integral(0.692, 0.872);
