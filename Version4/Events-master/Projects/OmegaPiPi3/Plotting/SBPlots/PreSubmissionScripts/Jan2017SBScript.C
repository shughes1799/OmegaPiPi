...
//  TH1F *MassXRightSubSB = new TH1F("MassXRightSubSB", "Only Right Sideband Subtracted, Mass X;MassX (GeV)", 100, 1.1, 1.9);
  TH1F *MassXLeftSubSignalSB = new TH1F("MassXLeftSubSignalSB", "Left region, Signal Subtracted, Mass X;MassX (GeV)", 200, 1.1, 1.9);
...
for(int l=1;l<201;l++){
  Double_t bgX = MXFullSide_All->GetBinContent(l);
