
{
 ...
 TFile *f = new TFile("Dec2016SBSliceTest4IndiFits1.root","RECREATE");
...
// }
 ...
 slice_histo1 = MOmvsMXAll_All->ProjectionX("Slice1 Fit",0,1);
 ...
 slice_histo2 = MOmvsMXAll_All->ProjectionX("Slice2 Fit",1,2);
 ...
 slice_histo3 = MOmvsMXAll_All->ProjectionX("Slice3 Fit",2,3);
 ...
 slice_histo4 = MOmvsMXAll_All->ProjectionX("Slice4 Fit",3,4);
 ...
 slice_histo5 = MOmvsMXAll_All->ProjectionX("Slice5 Fit",4,5);
