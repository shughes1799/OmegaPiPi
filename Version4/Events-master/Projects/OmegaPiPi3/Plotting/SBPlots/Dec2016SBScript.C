{
  ...
  TFile *f = new TFile("Jan2017BinnedMassXSubtractionsDeltas1.root","RECREATE");
  ...
  TFile *myFile = TFile::Open("Jan2017TestMassXBins4Deltas1.root");
  ...
  TH1F *MassXSB = new TH1F("MassXSB", "Sideband subtracted Mass X;MassX (GeV)", 200, 1.1, 1.9);
...
//   TH1F *MassPiPProSB = new TH1F("MassPiPPro", "Sideband subtracted Mass PiPPro", 100, 1, 1.9);
//   TH1F *MassPiMProSB = new TH1F("MassPiMPro", "Sideband subtracted Mass PiMPro", 100, 1, 1.9);
//   TH1F *MassPiPPiMSB = new TH1F("MassPiPPiM", "Sideband subtracted Mass PiPPiM", 100, 0.2, 1.1);
...
//  TH1F *MassXLeftSubSignalSB = new TH1F("MassXLeftSubSignalSB", "Left region, Signal Subtracted, Mass X;MassX (GeV)", 100, 1.1, 1.9);
//  TH1F *MassXRightSubSignalSB = new TH1F("MassXRightSubSignalSB", "Right region, Signal Subtracted, Mass X;MassX (GeV)", 100, 1.1, 1.9);
...
for(int k=1;k<201;k++){
  Double_t bgX = MXFullSide_All->GetBinContent(k);
  bgX = bgX/2;
  Double_t signalX = MXFullSignal_All->GetBinContent(k);
  Double_t subtractedX = signalX-bgX;
  MassXSB->SetBinContent(k,subtractedX);
 }

for(int l=1;l<51;l++){

//Mass of X Meson for bin 1, with sideband subtraction 
  Double_t bgX = MXSide1_All->GetBinContent(l);
  bgX = bgX/2;
  Double_t signalX = MXSignal1_All->GetBinContent(l);
  Double_t subtractedX = signalX-bgX;
  MassXSBBin1->SetBinContent(l,subtractedX);

  //Mass of X Meson for bin 2, with sideband subtraction 
  Double_t bgX = MXSide2_All->GetBinContent(l);
  bgX = bgX/2;
  Double_t signalX = MXSignal2_All->GetBinContent(l);
  Double_t subtractedX = signalX-bgX;
  MassXSBBin2->SetBinContent(l,subtractedX);

  //Mass of X Meson for bin 3, with sideband subtraction 
  Double_t bgX = MXSide3_All->GetBinContent(l);
  bgX = bgX/2;
  Double_t signalX = MXSignal3_All->GetBinContent(l);
  Double_t subtractedX = signalX-bgX;
  MassXSBBin3->SetBinContent(l,subtractedX);

  //Mass of X Meson for bin 4, with sideband subtraction 
  Double_t bgX = MXSide4_All->GetBinContent(l);
  bgX = bgX/2;
  Double_t signalX = MXSignal4_All->GetBinContent(l);
  Double_t subtractedX = signalX-bgX;
  MassXSBBin4->SetBinContent(l,subtractedX);

  //Mass of X Meson for bin 5, with sideband subtraction 
  Double_t bgX = MXSide5_All->GetBinContent(l);
  bgX = bgX/2;
  Double_t signalX = MXSignal5_All->GetBinContent(l);
  Double_t subtractedX = signalX-bgX;
  MassXSBBin5->SetBinContent(l,subtractedX);
 }
