{
 ...
 OutName="/home/dglazier/Work/Research/HaSpect/data/g11pippippim_missn_HS/Histo1.root";   // The name of the output directory or file
 SelName="ThreePiHisto1";    // The name of the selector to be produced
