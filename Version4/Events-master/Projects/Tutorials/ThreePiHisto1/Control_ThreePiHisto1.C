{
  //Set up the input chain to be analysed
   ...
   gSystem->Setenv("HSOUT",
		   "/home/dglazier/Work/Research/HaSpect/data/g11pippippim_missn_HS/Histo1.root");
   
   //Configure the analysis (i.e PROOF, source compilation...)
   TString HSANA=gSystem->Getenv("HSANA");
   gROOT->LoadMacro("/home/dglazier/Dropbox/HaSpect/Analysis/HaSpect/HSControl.C");
