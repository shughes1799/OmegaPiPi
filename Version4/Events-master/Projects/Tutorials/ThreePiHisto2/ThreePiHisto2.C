#define ThreePiHisto2_cxx
// The class definition in ThreePiHisto2.h has been generated automatically
...
//
// Root > T->Process("ThreePiHisto2.C")
// Root > T->Process("ThreePiHisto2.C","some options")
// Root > T->Process("ThreePiHisto2.C+")
//

#include "ThreePiHisto2.h"
#include <TH2.h>
#include <TStyle.h>


void ThreePiHisto2::Begin(TTree * /*tree*/)
{
...
void ThreePiHisto2::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t ThreePiHisto2::Process(Long64_t entry)
{
   THSOutput::HSProcessStart(entry);
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either ThreePiHisto2::GetEntry() or TBranch::GetEntry()
...
void ThreePiHisto2::SlaveTerminate()
{
...
void ThreePiHisto2::HistogramList(TString sLabel){
...
void ThreePiHisto2::FillHistograms(TString sCut,Int_t bin){
  fCurrCut=sCut;
  fCurrBin=bin;
