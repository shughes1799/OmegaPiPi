...
// Mon Jul  7 16:39:19 2014 by ROOT version 5.34/14
...
#ifndef ThreePiHisto2_h
#define ThreePiHisto2_h
...
class ThreePiHisto2 : public TSelector, public THSOutput {
public :
   ...
   ThreePiHisto2(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~ThreePiHisto2() { }
...
//Add THSHisto functions
   ...
   ClassDef(ThreePiHisto2,0);
};

#endif

#ifdef ThreePiHisto2_cxx
void ThreePiHisto2::Init(TTree *tree)
{
