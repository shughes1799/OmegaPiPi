{
 ...
 FileName="/home/dglazier/Work/Research/HaSpect/data/g11pippippim_missn_HSID2/inp1_50.root";   // The input filename containing the tree
 TreeName="HSParticles";   // The name of the tree
 OutName="/home/dglazier/Work/Research/HaSpect/data/g11pippippim_missn_HSID2/Weighted";   // The name of the output directory or file
 SelName="Simplify";    // The name of the selector to be produced
