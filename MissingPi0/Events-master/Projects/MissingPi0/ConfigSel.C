{
 ...
 FileName="/Disk/ds-sopa-group/np/thehubdata/thehub6/shughes/Haspect/OmegaPiPi/MissingPi0Data/FirstStageProcessed/16FilesMissingPi0.root";
 TreeName="HSParticles";   // The name of the tree
 OutName="/home/s0677668/Haspect/MissingPi0/Events-master/Projects/MissingPi0";   // The name of the output directory or file
 SelName="Corr_MissingPi0";    // The name of the selector to be produced
