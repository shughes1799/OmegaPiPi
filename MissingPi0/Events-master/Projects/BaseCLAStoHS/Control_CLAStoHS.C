{
  //Set the input files
   ...
   gSystem->Setenv("HSOUT",
		   ...
		   "/Disk/ds-sopa-group/np/thehubdata/thehub6/shughes/Haspect/OmegaPiPi/MissingPi0Data/FirstStageProcessed/16FilesMissingPi0.root");
   ...
   tree->Process("CLAStoHS.C++","proton:pi+:pi-:pi+:pi-");
}
