...
#ifndef analysis_acceptance2_h
#define analysis_acceptance2_h
...
class analysis_acceptance2 : public TSelector {
...
public :
  ...
  Float_t         rf_time;
   ...
   analysis_acceptance2(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis_acceptance2() { }
   ...
   ClassDef(analysis_acceptance2,0);
};

#endif

#ifdef analysis_acceptance2_cxx
void analysis_acceptance2::Init(TTree *tree)
{
...
Bool_t analysis_acceptance2::Notify()
{
...
#endif // #ifdef analysis_acceptance2_cxx
