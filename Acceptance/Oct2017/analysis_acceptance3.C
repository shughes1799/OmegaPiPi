#define analysis_acceptance3_cxx
...
#include "analysis_acceptance3.h"
#include <TH2.h>
#include <TStyle.h>
#include <iostream>

void analysis_acceptance3::Begin(TTree * /*tree*/)
{
...
void analysis_acceptance3::SlaveBegin(TTree * /*tree*/)
{
   ...
   h1_mass_omega2  = new TH1F("h1_mass_omega2","Mass #omega; GeV",180,0.692,0.872);
   ...
   h1_mass_omega_pi_pi  = new TH1F("h1_mass_omega_pi_pi","Invariant Mass (#omega + #pi^{+} + #pi^{-}); GeV",180,1.1,1.9);
...
Bool_t analysis_acceptance3::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either analysis_acceptance3::GetEntry() or TBranch::GetEntry()
  ...
  //v4_omegapipi2 = v4_pip1 + v4_pim1 + v4_omega2;

  v4_omega3 = v4_pip1 + v4_pim2 + v4_pi0;
  v4_omega4 = v4_pip2 + v4_pim1 + v4_pi0;

  v4_omegapipi = v4_pip1 + v4_pim1 + v4_omega2;
...
void analysis_acceptance3::SlaveTerminate()
{
...
void analysis_acceptance3::Terminate()
{
  ...
  //TFile file_out("PSFirst10mil.root","recreate");
  TFile file_out("PSMain100mil.root","recreate");
...
Bool_t analysis_acceptance3::MakeBeam(Float_t Tmid,Float_t Tcut){
