...
// Thu May 18 12:30:50 2017 by ROOT version 5.34/34
// from TChain h10/
//////////////////////////////////////////////////////////

#ifndef analysis_acceptance3_h
#define analysis_acceptance3_h
...
class analysis_acceptance3 : public TSelector {

Bool_t MakeBeam(Float_t Tmid,Float_t Tcut); 
...
public :
  ...
  TH1F           *h1_omega_pi_pi_to_5pi_vertex_sep;

  //Simon Histrograms
  TH2F *h2_mass_omega_vs_mass_omega_pi_pi;
  ...
  TH1F *h1_mass_proton_recon;
  TH1F *h1_mass_pip1_recon;
  TH1F *h1_mass_pim1_recon;

  TH1F *h1_mass_proton_recon_filt;
  TH1F *h1_mass_pip1_recon_filt;
  TH1F *h1_mass_pim1_recon_filt;
  TH1F *h1_mass_missing_recon_filt;
  TH1F *h1_mass_omegapipi_recon_filt;

  TH1F *h1_missing_throwleft_getleft;
  TH1F *h1_missing_throwleft_getsignal;  
  TH1F *h1_missing_throwleft_getright;

  TH1F *h1_missing_throwsignal_getleft;
  TH1F *h1_missing_throwsignal_getsignal;  
  TH1F *h1_missing_throwsignal_getright;

  TH1F *h1_missing_throwright_getleft;
  TH1F *h1_missing_throwright_getsignal;  
  TH1F *h1_missing_throwright_getright;

  TH1F *h1_omegapipi_throwleft_getleft;
  TH1F *h1_omegapipi_throwleft_getsignal;  
  TH1F *h1_omegapipi_throwleft_getright;

  TH1F *h1_omegapipi_throwsignal_getleft;
  TH1F *h1_omegapipi_throwsignal_getsignal;  
  TH1F *h1_omegapipi_throwsignal_getright;

  TH1F *h1_omegapipi_throwright_getleft;
  TH1F *h1_omegapipi_throwright_getsignal;  
  TH1F *h1_omegapipi_throwright_getright;
  ...
  Float_t         rf_time;
   ...
   analysis_acceptance3(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis_acceptance3() { }
   ...
   ClassDef(analysis_acceptance3,0);
};

#endif

#ifdef analysis_acceptance3_cxx
void analysis_acceptance3::Init(TTree *tree)
{
...
Bool_t analysis_acceptance3::Notify()
{
...
#endif // #ifdef analysis_acceptance3_cxx
